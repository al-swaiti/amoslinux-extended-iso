...
echo
	...
	amosVersion='v22.09.01'

	isoLabel='AmOsLinux-extended-'$amoslinuxVersion'-x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 66-1"
	buildFolder=$HOME"/amoslinux-build"
	outFolder=$HOME"/AmOsLinux-Out"
	archisoVersion=$(sudo pacman -Q archiso)

	echo "################################################################## "
	echo "Building the desktop                   : "$desktop
	echo "Building version                       : "$amoslinuxVersion
...
echo
	...
	echo "Getting the last version of bashrc in /etc/skel"
	echo
	wget https://raw.githubusercontent.com/amanre/amos-root/master/etc/skel/.bashrc-latest -O $buildFolder/archiso/airootfs/etc/skel/.bashrc
...
echo
	...
	#profiledef.sh
	oldname1='iso_name="amoslinux-extended'
	newname1='iso_name="amoslinux-extended'

	oldname2='iso_label="amoslinux-extended'
	newname2='iso_label="amoslinux-extended'
